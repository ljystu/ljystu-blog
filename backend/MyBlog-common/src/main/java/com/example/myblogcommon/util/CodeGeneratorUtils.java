...
public class CodeGeneratorUtils {
    ...
    public static void main(String[] args) {
        ...
        gc.setOutputDir(projectPath + "/backend/MyBlog-common/src/main/java");
        gc.setAuthor("ljystu");
        ;
        ...
        pc.setParent("com.example.myblogcommon");
        ...
        InjectionConfig cfg = new InjectionConfig() {
            ...
            public void initMap() {
                ...
                map.put("basePath", "com.example.myblogcommon");
                this.setMap(map);
            }
        };
        ...
        strategy.setSuperControllerClass("com.example.myblogcommon.base.AbstractController");
