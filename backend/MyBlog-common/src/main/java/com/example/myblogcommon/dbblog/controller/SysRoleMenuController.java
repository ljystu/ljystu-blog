...
public class SysRoleMenuController extends AbstractController {
    @Autowired
    private SysRoleMenuService roleService;
    ...
    public Result info(@PathVariable("id") String id) {
        SysRoleMenu role = roleService.getById(id);
    ...
    public Result save(@RequestBody SysRoleMenu role) {
    ...
    public Result update(@RequestBody SysRoleMenu role) {
        ValidatorUtils.validateEntity(role);
